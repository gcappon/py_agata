...
from py_agata.inspection import find_hyperglycemic_events


def test_find_hyperglycemic_events():
    """
    Unit test of find_hyperglycemic_events function.
    ...
    results = find_hyperglycemic_events(data)
    ...
    glucose[84:87] = np.ones(shape=(3,)) * 250
    d = {'t': t, 'glucose': glucose}
    data = pd.DataFrame(data=d)
