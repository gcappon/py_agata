...
def test_median_glucose():
    """
    Unit test of median_glucose function.
    ...
    #Tests
    assert np.isnan(median_glucose(data)) == False
    assert median_glucose(data) == 120
    ...
    # Tests
    assert np.isnan(median_glucose(data))
