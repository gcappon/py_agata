...
from py_agata.variability import cvga


def test_cvga():
    """
    Unit test of cvga function.
    ...
    #Tests
    assert np.isnan(cvga(data)) == False
    assert np.round(cvga(data)*1000)/1000 == 4759.436
