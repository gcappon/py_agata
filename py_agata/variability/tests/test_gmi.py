...
from py_agata.variability import gmi


def test_gmi():
    """
    Unit test of gmi function.
    ...
    #Tests
    assert np.isnan(gmi(data)) == False
    assert np.round(gmi(data)*100)/100 == 6.61
