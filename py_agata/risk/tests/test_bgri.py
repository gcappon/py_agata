...
from py_agata.risk import bgri


def test_bgri():
    """
    Unit test of bgri function.
    ...
    #Tests
    assert np.isnan(bgri(data)) == False
    assert np.round(bgri(data)*1000)/1000 == 15.8350
