...
from py_agata.risk import lbgi


def test_lbgi():
    """
    Unit test of lbgi function.
    ...
    #Tests
    assert np.isnan(lbgi(data)) == False
    assert np.round(lbgi(data)*1000)/1000 == 8.5430
