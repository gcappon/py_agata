...
from py_agata.risk import adrr


def test_adrr():
    """
    Unit test of adrr function.
    ...
    #Tests
    assert np.isnan(adrr(data)) == False
    assert np.round(adrr(data)*1000)/1000 == 61.1280
