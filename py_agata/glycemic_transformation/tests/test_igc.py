...
from py_agata.glycemic_transformation import igc


def test_igc():
    """
    Unit test of igc function.
    ...
    #Tests
    assert np.isnan(igc(data)) == False
    assert np.round(igc(data)*1000)/1000 == 6.673
