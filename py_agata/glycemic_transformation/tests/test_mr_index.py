...
from py_agata.glycemic_transformation import mr_index


def test_mr_index():
    """
    Unit test of mr_index function.
    ...
    #Tests
    assert np.isnan(mr_index(data)) == False
    assert np.round(mr_index(data)*1000)/1000 == 31.695
